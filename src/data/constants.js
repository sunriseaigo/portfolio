export const Bio = {
  ...
  github: "https://github.com/sunrise208",
  resume:
...
export const experiences = [
  {
    ...
    archivements: [
      "Implemented a vibrant new DeFi ecosystem, reinfored rigorous security measures and smart contract auditing to mitigate potential vulnerabilities, code exploits, and ensure the protection of user funds is critical.",
      "Wrote GraphQL schemas for a subgraph to improve the eA ciency, which resulted in a 5% reducing time for request.",
      "Reviewed code and merged branches including rebasting andsquashing commits via Git.",
      "Successfully led the development of a new platform feature, which resulted in a 4% increase in daily user activity",
    ],
...
export const projects = [
  ...
  },
  {
    ...
    category: "web app",
    github: "https://github.com/sunrise208/trackify",
  ...
  },
  {
    ...
    category: "web app",
    github: "https://github.com/sunrise208/podstream",
...

  {
    ...
    category: "web app",
    github: "https://github.com/sunrise208/breaking-bad-web",
